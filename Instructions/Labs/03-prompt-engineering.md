...
4. Vergewissern Sie sich, dass der links oben im Cloud Shell-Bereich angegebene Shelltyp *Bash* ist. Sollte *PowerShell* angezeigt werden, wechseln Sie über das Dropdownmenü zu *Bash*.
